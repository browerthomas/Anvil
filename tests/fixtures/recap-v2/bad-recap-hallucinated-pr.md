...
- S1 — slice-1 lifted.
- S2 — slice-2 wired the resolver.
- S3 — slice-3 added the citation pass.

## What assumptions changed

- We assumed event-log shape was append-only without revisions; the new resume event broke that. See #9999.
